const mockedCompanies = [
  {
    ...
    categories: ["lawn"],
    services: ["Commercial lawn care", "Artificial turf", "Pavers", "Lawn maintenance", "Hardscapes", "Sod installation", "Residential", "Landscaping"],
    highlights: ["helps educate customers", "free quotes", "punctual service", "transparent pricing"],
    lowlights: {
  ...
  },
  {
    ...
    highlights: ["helps educate customers", "good customer service", "transparent pricing"],
    lowlights: {
      lawn: ["small online presence"],
    },
    certifications: {},
  ...
  },
  {
    ...
    categories: ["lawn"],
    services: ["Irrigation", "Outdoor living space", "Tree and shrub pruning", "Lawn maintenance", "Weed control", "Residential", "Landscaping", "Commercial lawn care", "Tree and shrub trimming"],
    highlights: ["helps educate customers", "transparent pricing", "good customer service", "free quotes"],
    lowlights: {
      lawn: ["small online presence"],
    },
    certifications: {},
  ...
  },
  {
    ...
    social_media: {
      facebook: "https://www.facebook.com/Southwest-Greens-of-Tucson-172200253727",
    ...
    categories: ["lawn"],
    services: ["Residential", "Sod installation", "Landscaping", "Lawn maintenance", "Commercial lawn care", "Artificial turf", "Lawn mowing", "Irrigation", "Fertilizing"],
    highlights: ["helps educate customers", "good customer service", "transparent pricing"],
    lowlights: {
      lawn: ["small online presence"],
    },
  ...
  },
  {
    ...
    categories: ["lawn"],
    services: ["Debris removal", "Pond installation and maintenance", "Landscaping", "Residential", "Hardscapes", "Tree and shrub pruning", "Weed control", "Fertilizing", "Commercial lawn care", "Pavers", "Outdoor living space", "Lawn mowing", "Lawn maintenance", "Irrigation"],
  ...
  },
  {
    ...
    categories: ["lawn"],
    services: ["Residential", "Lawn maintenance", "Landscaping", "Commercial lawn care"],
...
export default function companyHandler(request, response) {
